...
export async function updateMe(uid, { name, bio, avatarFile, username, pronouns, links, gender, anthem, anthemArtist, anthemUrl }) {
  const patch = {}
  ...
  if (typeof anthem === 'string') patch.anthem = anthem.trim().slice(0, 80)
  if (typeof anthemArtist === 'string') patch.anthemArtist = anthemArtist.trim().slice(0, 60)
  if (typeof anthemUrl === 'string') patch.anthemUrl = anthemUrl.slice(0, 300)
  if (avatarFile) {
